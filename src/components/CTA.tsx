...
const FORMSPREE_URL = 'https://formspree.io/f/mzblzyrp';
  ...
  return (
    <section id="contact" className="py-20 px-6 bg-gray-50">
      <div className="container mx-auto max-w-4xl">
        <h2 className="text-4xl font-bold text-center mb-4 text-gray-800">{t('cta.title')}</h2>
        <p className="text-xl text-center mb-12 text-gray-600">
          {t('cta.subtitle')}
        </p>

        <form ref={formRef} onSubmit={sendEmail} className="max-w-lg mx-auto mb-12">
          <div className="mb-4">
          ...
          <div className="mb-4">
            <label htmlFor="from_email" className="block text-gray-700 font-medium mb-2">
              {t('cta.form.email')}
            </label>
            <input
              type="email"
          ...
          {status === 'success' && (
            <p className="mt-4 text-center text-green-600 font-medium">{t('cta.form.success')}</p>
          )}
          {status === 'error' && (
            <p className="mt-4 text-center text-red-600 font-medium">{t('cta.form.error')}</p>
          )}
        </form>

        <div className="text-center">
          <p className="text-gray-600 mb-4">{t('cta.socials')}</p>
          <div className="flex justify-center gap-6">
            ...
            <a
              href="mailto:jerezvelasquez.j@gmail.com"
